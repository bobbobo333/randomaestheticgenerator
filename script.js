...
function generateHat() {
    ...
    const result = document.getElementById("hat");

    const possibleHat = Math.random() < 0.20;
    ...
    if (possibleHat) {
        ...
        const aesthetic = randomAesthetic(hats);

        const item = randomItem(hats, aesthetic);
    ...
    rollResult(result, finalResult, function () {

        button.textContent = "HAT LOCKED";
...
function generateLayerResults(layerCount) {
    ...
    layerNames.forEach(function (layerName, index) {
        ...
        layerContainer.appendChild(box);
        ...
        setTimeout(function () {
            ...
            // Outer layer has a chance of being absent
            if (
                layerName === "Outer Layer" &&
                Math.random() < 0.25
            ) {

                finalResult = "NO OUTER LAYER";
    ...
    document.getElementById("layerButton").textContent =
        "LAYERS LOCKED";
}
...
function generateBottom() {
    ...
    const aesthetic =
        randomAesthetic(bottoms);

    const item =
        randomItem(bottoms, aesthetic);
...
function generateAccessoryResults(count) {
    ...
    for (let i = 0; i < count; i++) {
        ...
        setTimeout(function () {
            ...
            do {
                ...
                item =
                    randomItem(accessories, aesthetic);
    ...
    document.getElementById("accessoryButton").textContent =
        "ACCESSORIES LOCKED";
}
